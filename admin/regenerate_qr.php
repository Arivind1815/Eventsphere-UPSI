...
$qr_content = 'https://https://treefrog-moving-uniformly.ngrok-free.app/eventspehere/student/mark_attendance.php?event=' . $event_id . '&token=' . $token;
...
// Return success with the new QR code URL
echo json_encode([
    'success' => true, 
    'qr_url' => $qr_url,
